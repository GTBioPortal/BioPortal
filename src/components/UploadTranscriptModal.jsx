...
import { hideUploadTranscript, showUploadSnackbar }  from '../actions/modals'
 ...
 * computer
 */
class UploadTranscriptModal extends React.Component {
    constructor(props) {
        super(props);
    ...
    uploadFile() {
        if (!this.state.fileSelected) {
            ...
            this.props.hideUploadTranscript();
    ...
    render () {
        return (
            <Modal
                open={true}
                onClose={this.props.hideUploadTranscript}>
                <div className='resume-modal'>
                    <Typography variant='headline'>
                        <span className='modal-title'>Upload Transcript</span>
                    </Typography>
                    <div id='file-upload'>
                        <input
                    ...
                    <div id='buttons'>
                        ...
                        <Button variant='outlined'
                            onClick={this.props.hideUploadTranscript}>
                            Close
                        </Button>
                    </div>
                </div>
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators({ hideUploadTranscript, showUploadSnackbar }, dispatch);
}
