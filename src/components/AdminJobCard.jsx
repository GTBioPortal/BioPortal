 ...
 */
class AdminJobCard extends React.Component {
    ...
    viewJob() {
        ...
        const path = '/adminViewJobDetails/' + job.id;
        localStorage.setItem('admin-job-id', job.id)
...
export default withRouter (AdminJobCard);